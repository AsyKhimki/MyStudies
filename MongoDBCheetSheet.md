...
| Nr             | Topic| Notes &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  | Reference |
| :------| :------ |:---- | :----------------|
4.1 | Given a scenario with three collections (a parent and two children) and the user, identify the embedded relationships and which should be linked.| **Data Modelling**</br> - the process of defining how data is stored </br> - the process of defining the relationships that exist among different entities in your data. </br></br> **Benefits of good data models**</br> - A proper data model makes it easier to manage your data. </br> - A proper data model makes queries more efficient. </br> - A proper data model uses less memory and CPU. </br> - A proper data model reduces costs. </br>**Embedding**</br> - Single query to retrieve data </br> - Single operation to update/delete data </br> - Data duplication </br> - Large documents </br> </br> **Referencing** </br> - No duplication </br> - Smaller documents </br> - Need to join data from multiple documents| - [Embedding vs referencing](https://www.mongodb.com/docs/manual/data-modeling/concepts/embedding-vs-references/) | 
