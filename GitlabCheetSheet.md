...
<h4> Primary </h4>
  ...
  3. [List of Gitlab templates](https://gitlab.com/gitlab-org/gitlab-foss/tree/master/lib/gitlab/ci/templates) (see folder **Jobs**)

<h4> Miscellaneous </h4>

  1. [Gitlab lab materials](https://handbook.gitlab.com/handbook/customer-success/professional-services-engineering/education-services/gitlabcicdhandson/)
  2. [Deep Dive into Review Apps](https://www.youtube.com/watch?v=HblSiPFamDI)
  3. [Gitlab variables](https://docs.gitlab.com/ee/ci/variables/index.html#define-a-cicd-variable-in-the-ui)
...
|Upload a docker image to the  GitLab Container Registry|<img width="600" alt="Screenshot 2024-10-02 at 23 41 33" src="https://github.com/user-attachments/assets/3a1c8874-dda4-4694-aa84-edb21148ea12">| - In the left navigation pane, click Deploy > Container Registry and view the container that was just uploaded by the build image job.|
| Configure manual deployment on a production server |   <img width="600" alt="Screenshot 2024-09-22 at 13 33 35" src="https://github.com/user-attachments/assets/b1462d41-b9e1-49c1-931c-29fad9cd7d97">   | - [List of pre-defined gitlab variables](https://docs.gitlab.com/ee/ci/variables/predefined_variables.html) <br> - `$CI_COMMIT_BRANCH`: This variable holds the name of the branch that the current commit belongs to <br> - `$CI_DEFAULT_BRANCH`: This variable holds the name of the default branch of your project. In most cases, the default branch is main or master <br> - job will only run if the current commit is made on the default branch. |
...
|Add code quality scanning|<img width="600" alt="Screenshot 2024-10-04 at 11 55 01" src="https://github.com/user-attachments/assets/f425b01f-cd7e-489f-b3ca-ad105f6b5459">|- On the pipeline details screen, click the Code Quality tab above the pipeline graph|
|Job templates|||
...
|Create a variable|<img width="600" alt="Screenshot 2024-10-04 at 11 57 24" src="https://github.com/user-attachments/assets/10c9d24e-02df-4b38-9f64-ce16b2bd9d06">|Reference <br> -[Gitlab variables](https://docs.gitlab.com/ee/ci/variables/index.html#define-a-cicd-variable-in-the|
